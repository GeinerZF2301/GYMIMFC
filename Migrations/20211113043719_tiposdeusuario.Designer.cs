...
namespace GYMIMFC.Migrations
{
    ...
    [Migration("20211113043719_tiposdeusuario")]
    partial class tiposdeusuario
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GYMIMFC.Models.TipoUsuario", b =>
                {
            ...
            modelBuilder.Entity("GYMIMFC.Models.TipoUsuarioPagina", b =>
                {
                    b.Property<int>("Tipousuariopaginaid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("Tipousuariopaginaid");

                    b.HasIndex("Tipousuarioid");

                    b.ToTable("TipoUsuarioPagina");
                });

            modelBuilder.Entity("GYMIMFC.Models.Usuario", b =>
                {
            ...
            modelBuilder.Entity("GYMIMFC.Models.TipoUsuarioPagina", b =>
                {
                    b.HasOne("GYMIMFC.Models.TipoUsuario", null)
                        .WithMany("TipoUsuarioPagina")
                        .HasForeignKey("Tipousuarioid");
                });

            modelBuilder.Entity("GYMIMFC.Models.Usuario", b =>
                {
                    b.HasOne("GYMIMFC.Models.TipoUsuario", "TipoUsuario")
                        .WithMany("Usuario")
                        .HasForeignKey("TipoUsuarioId")
            ...
            modelBuilder.Entity("GYMIMFC.Models.TipoUsuario", b =>
                {
                    b.Navigation("TipoUsuarioPagina");
